...
<div class="container">
    <div align="center">
        ...
        <form action="${regUrl}" method="POST">
            <div class="row">
                <div class="col-4" align="right">Login:</div>
                <div class="col-8" align="left"><input type="text" name="login" value="${login}"></div>
            </div>
            <div class="row">
                <div class="col-4" align="right">Password:</div>
                <div class="col-8" align="left"><input type="password" name="password"></div>
            </div>
            <div class="row">
