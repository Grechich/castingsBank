...
<div class="container">
    <div class="container-fluid" style="text-align: center">
        <H3><a href="http://www.dsz.dp.ua/"> Днепропетровский стрелочный завод</a></H3>
        <p> АО «ДНЕПРОПЕТРОВСКИЙ СТРЕЛОЧНЫЙ ЗАВОД» - предприятие со 100-летним опытом производства элементов верхнего
            строения пути с замкнутым циклом. Численность компании составляет более 700 работников.        </p>

        <p> Продукцию АО «ДНЕПРОПЕТРОВСКИЙ СТРЕЛОЧНЫЙ ЗАВОД» активно используют в Азербайджане, Белоруссии, Казахстане,
            Молдове, Туркменистане, Узбекистане, Грузии и др странах СНГ, а также в Боснии и Герцеговине, Эстонии,
            Латвии, Литве, Испании, Турции и др. странах.        </p>

        <p> Потребители продукции АО «ДНЕПРОПЕТРОВСКИЙ СТРЕЛОЧНЫЙ ЗАВОД» – это железнодорожные компании, морские порты,
            паромные переправы, рудники и шахты, метрополитены, промышленные предприятия, городской
            электротранспорт. </p>
    </div>
</div>
<!--Data-->
